...
exports.createBooking = async (req, res, next) => {
  try {
    ...
    const serviceProviderBookings = await getBookingsForServiceProviderByDate(
...
const getBookingsForServiceProviderByDate = async (
  service_provider_id,
  date
) => {
  const bookings = await BookingModel.find({
...
exports.getBookingsForStylistByDate = async (req, res, next) => {
  try {
    ...
    const bookings = await getBookingsForServiceProviderByDate(
      stylist_id,
      date
    );
